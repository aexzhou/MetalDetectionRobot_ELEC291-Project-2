...
; This file was generated Tue Apr 02 16:41:01 2024
;--------------------------------------------------------
$name Controller
$optc51 --model-small
	R_DSEG    segment data
...
;--------------------------------------------------------
	rseg R_DINIT
;	Controller.c:5: int t = 0; //global variable, used to reduce the speed for timer4 isr
	clr	a
	mov	_t,a
	mov	(_t + 1),a
...
;------------------------------------------------------------
;	Controller.c:12: void printCharAsBinary(char c) {
;	-----------------------------------------
;	 function printCharAsBinary
;	-----------------------------------------
_printCharAsBinary:
	mov	r2,dpl
;	Controller.c:16: for (i = 7; i >= 0; i--) {
	mov	r3,#0x07
	mov	r4,#0x00
L033001?:
	mov	a,r4
	jb	acc.7,L033004?
;	Controller.c:17: out = (c >> i) & 1; // Shift right i bits, and mask all but the least significant bit
	mov	b,r3
	inc	b
	mov	a,r2
	rlc	a
...
;------------------------------------------------------------
;	Controller.c:23: void main (void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	Controller.c:33: waitms(500);
	mov	dptr,#0x01F4
	lcall	_waitms
;	Controller.c:34: UART1_Init(9600);
	mov	dptr,#0x2580
	clr	a
	mov	b,a
	lcall	_UART1_Init
;	Controller.c:37: InitPinADC(2, 1); // Configure P2.1 as analog input
	mov	_InitPinADC_PARM_2,#0x01
	mov	dpl,#0x02
	lcall	_InitPinADC
;	Controller.c:38: InitPinADC(2, 2); // Configure P2.2 as analog input
	mov	_InitPinADC_PARM_2,#0x02
	mov	dpl,#0x02
	lcall	_InitPinADC
;	Controller.c:39: InitPinADC(2, 3); // Configure P2.3 as analog input
	mov	_InitPinADC_PARM_2,#0x03
	mov	dpl,#0x02
	lcall	_InitPinADC
;	Controller.c:40: InitPinADC(2, 4); // Configure P2.4 as analog input
	mov	_InitPinADC_PARM_2,#0x04
	mov	dpl,#0x02
	lcall	_InitPinADC
;	Controller.c:41: InitPinADC(2, 5); // Configure P2.5 as analog input
	mov	_InitPinADC_PARM_2,#0x05
	mov	dpl,#0x02
	lcall	_InitPinADC
;	Controller.c:42: InitPinADC(2, 6); // Configure P2.6 as analog input
	mov	_InitPinADC_PARM_2,#0x06
	mov	dpl,#0x02
	lcall	_InitPinADC
;	Controller.c:43: InitADC();
	lcall	_InitADC
;	Controller.c:45: LCD_4BIT();
	lcall	_LCD_4BIT
;	Controller.c:47: printf("\n\n---- Press and Hold both Joysticks to Calibrate ----\n");
	mov	a,#__str_5
	push	acc
	mov	a,#(__str_5 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	Controller.c:48: Wait_For_Calibration();
	lcall	_Wait_For_Calibration
;	Controller.c:49: waitms(200);
	mov	dptr,#0x00C8
	lcall	_waitms
;	Controller.c:51: SendATCommand("AT+BAUD\r\n");
	mov	dptr,#__str_6
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:52: SendATCommand("AT+BAUD\r\n");
	mov	dptr,#__str_6
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:53: SendATCommand("AT+RFID\r\n");
	mov	dptr,#__str_7
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:54: SendATCommand("AT+DVIDA0C4\r\n");
	mov	dptr,#__str_8
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:55: SendATCommand("AT+RFC\r\n");  
	mov	dptr,#__str_9
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:56: SendATCommand("AT+POWE\r\n");
	mov	dptr,#__str_10
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:57: SendATCommand("AT+CLSS\r\n");
	mov	dptr,#__str_11
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:58: SendATCommand("AT+VER\r\n");
	mov	dptr,#__str_12
	mov	b,#0x80
	lcall	_SendATCommand
;	Controller.c:61: printf("\n\n---- CONTROLLER SETUP COMPLETE ----\n");
	mov	a,#__str_13
	push	acc
	mov	a,#(__str_13 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	Controller.c:65: while(1)
L034011?:
;	Controller.c:68: sw_left = Volts_at_Pin(QFP32_MUX_P2_6);
	mov	dpl,#0x13
	lcall	_Volts_at_Pin
...
;	Controller.c:69: vx_left = Volts_at_Pin(QFP32_MUX_P2_5);
	mov	dpl,#0x12
	lcall	_Volts_at_Pin
...
;	Controller.c:70: vy_left = Volts_at_Pin(QFP32_MUX_P2_4);
	mov	dpl,#0x11
	lcall	_Volts_at_Pin
...
;	Controller.c:72: sw_right = Volts_at_Pin(QFP32_MUX_P2_1);
	mov	dpl,#0x0E
	lcall	_Volts_at_Pin
...
;	Controller.c:73: vx_right = Volts_at_Pin(QFP32_MUX_P2_2);
	mov	dpl,#0x0F
	lcall	_Volts_at_Pin
...
;	Controller.c:74: vy_right = Volts_at_Pin(QFP32_MUX_P2_3);
	mov	dpl,#0x10
	lcall	_Volts_at_Pin
	mov	r6,dpl
	mov	r7,dph
	mov	r2,b
	mov	r3,a
;	Controller.c:76: vx1 = Voltage_to_Coordinate(vx_left);
...
;	Controller.c:77: vy1 = Voltage_to_Coordinate(vy_left);
...
;	Controller.c:78: vx2 = Voltage_to_Coordinate(vx_right);
	...
	pop	ar3
	pop	ar2
;	Controller.c:79: vy2 = Voltage_to_Coordinate(vy_right);
	mov	dpl,r6
	mov	dph,r7
	mov	b,r2
	mov	a,r3
	...
	pop	ar5
	pop	ar4
;	Controller.c:80: sw1 = Check_Joystick_Button(sw_left); //Returns 1 if pressed, 0 otherwise
...
;	Controller.c:91: Generate_Motor_Command(&mcmd1,vx1,vy1);
	...
	pop	ar3
	pop	ar2
;	Controller.c:92: Generate_Motor_Command(&mcmd2,vx2,vy2);
	...
	mov	b,#0x40
	lcall	_Generate_Motor_Command
;	Controller.c:93: Weigh_Dual_Inputs(&mcmd,&mcmd1,&mcmd2,0.2);
...
;	Controller.c:95: sprintf(tbuff,"%3d,%3d C T\n",mcmd.left,mcmd.right);
	mov	r0,#(_mcmd + 0x0002)
	mov	ar2,@r0
	inc	r0
	mov	ar3,@r0
...
;	Controller.c:98: printf('\r');
	...
	dec	sp
	dec	sp
;	Controller.c:99: sendstr1(tbuff);
	mov	dptr,#_tbuff
	mov	b,#0x40
	lcall	_sendstr1
;	Controller.c:101: while(1){ // check if there's data to recieve 
	mov	r2,#0x00
	mov	r3,#0x00
L034006?:
;	Controller.c:102: if(RXU1()) break;
	push	ar2
	push	ar3
	lcall	_RXU1
	pop	ar3
...
;	Controller.c:103: Timer3us(100);
	...
	pop	ar3
	pop	ar2
;	Controller.c:104: timeout++;
	inc	r2
	cjne	r2,#0x00,L034021?
	inc	r3
L034021?:
;	Controller.c:105: if(timeout>1000) break;
	clr	c
	mov	a,#0xE8
	subb	a,r2
	mov	a,#(0x03 ^ 0x80)
	...
	jnc	L034006?
L034007?:
;	Controller.c:107: if(RXU1()){
	lcall	_RXU1
	jc	L034023?
	ljmp	L034011?
L034023?:
;	Controller.c:108: getstr1(rbuff);
	mov	dptr,#_rbuff
	mov	b,#0x40
	lcall	_getstr1
	ljmp	L034011?
